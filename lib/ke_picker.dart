...
class KeCupertinoPicker extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _KeCupertinoPickerState();
}

class _KeCupertinoPickerState extends State<KeCupertinoPicker> {
  ...
  @override
  void didUpdateWidget(KeCupertinoPicker oldWidget) {
  ...
  /// Makes the fade to [KeCupertinoPicker.backgroundColor] edge gradients.
        ...
        children: <Widget>[
          ...
          Container(
            decoration: const BoxDecoration(
              border: Border(
                top: BorderSide(width: 0.5, color: _kHighlighterBorder),
                bottom: BorderSide(width: 0.5, color: _kHighlighterBorder),
              ),
            ),
